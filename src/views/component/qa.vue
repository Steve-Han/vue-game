      ...
      <div class="drawer-update" v-if="showExtrasInfo">
        ...
        <div class="scroll">
          <div class="info" v-for="(item,index) in update" :key="index">
            ...
            <p style="padding-left:0"><img src="../../assets/img/35017881.jpg" alt="">:<span>{{ item.standby1 }}</span>
            </p>
          </div>
        </div>
      </div>
...
onMounted(() => {
  checkedUpdateInfo.value = localStorage.getItem('checkedUpdateInfo')
...
async function getSuggest() {
  ...
  axiosInstance.then(async e => {
    try {
      let data = await e.post(
